...
Public Class frmTrishuul
    ...
    Private Sub WHOWEAREToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles WHOWEAREToolStripMenuItem.Click
        ...
        Dim sql As String = "SELECT * from WHOWEARE where ID like'TRI0%' "
    ...
    Private Sub HOWCANWEHELPToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HOWCANWEHELPToolStripMenuItem1.Click
        frmGrievance.Show()
    End Sub
    ...
    Private Sub ABOUTUSToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ABOUTUSToolStripMenuItem.Click
        Dim connectionString As String = "Data Source=PROJECT34;Initial Catalog=NGOdb;Integrated Security=True"
        Dim sql As String = "SELECT * from WHATWEDO where ID like 'TRI0%'"
        Dim connection As New SqlConnection(connectionString)
        Dim dataadapter As New SqlDataAdapter(sql, connection)
        connection.Open()
